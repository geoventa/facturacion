...
export const appRoutes: Route[] = [
    ...
    {path: '', pathMatch : 'full', redirectTo: 'autenticacion-por-token'},
    ...
    // Auth routes for guests
    {
        ...
        children: [
            {
                path: 'autenticacion-por-token/:token',
                loadChildren: (): any =>
                    import('app/modules/autenticacion-por-token/autenticacion-por-token.module').then(m => m.AutenticacionPorTokenModule)
            },
            {path: 'confirmation-required', loadChildren: (): any =>
                    import('app/modules/auth/confirmation-required/confirmation-required.module').then(m => m.AuthConfirmationRequiredModule)},
            {path: 'forgot-password', loadChildren: (): any =>
                    import('app/modules/auth/forgot-password/forgot-password.module').then(m => m.AuthForgotPasswordModule)},
            {path: 'reset-password', loadChildren: (): any =>
