...
export class MisFacturasComponent implements OnInit {
    ...
    crearConsulta(): void {
        ( this.listaFacturaService.getHoy(this.vendedorSelecionado))
            .subscribe((response) => {
                ...
                this.clientes = this.listaFacturasVista.clientes;
                this.facturas = this.listaFacturasVista.facturas;
                this.abonos = this.listaFacturasVista.abonos;
                this.filtrarFacturas();
            }, (error) => {
                console.error(error);
                this.listaFacturasVista = new ListaFacturaVista();
                this.facturas = [];
    ...
    getFacturaModelo(idFactura: number): Factura {
        let factura: Factura;
        this.facturas.forEach((item) => {
    ...
    getClienteModelo(idCliente: number): Cliente{
        let cliente: Cliente;
    ...
    getVendedorModelo(idVendedor: number): Vendedor {
    ...
    getRutaModelo(idRuta: number): Ruta{
        let ruta: Ruta = null;
